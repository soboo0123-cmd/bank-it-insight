    ...
    prompt = f"""
        ...
        2. <카테고리별 핵심 뉴스 요약>:
           ...
           - **[선별 기준]**: 
             ...
             2) 단순 홍보성 기사보다는 '기술 도입', '제휴', '규제 대응' 등 전략적 가치가 높은 뉴스 위주로 선택하세요.
             
           - **[레이아웃]**:
             - 카테고리 제목(<h3>) 옆에 [핵심 트렌드]를 한 줄로 요약하세요.
             - 선택된 기사는 <ul>과 <li>를 사용하며, 제목에 원문 링크를 삽입하세요.
             - **[중요]** 각 기사의 [기사내용desc]는 원문 그대로 표시하되, 너무 길 경우 가독성을 위해 해당 기사의 핵심 문장 위주로 최대 3문장까지만 포함하세요. (전체 나열 지양)
